...
exports.RequestHandler = function RequestHandler(worker, _ref, _ref2) {
  ...
  var call = _ref2.call,
      put = _ref2.put,
      delay = _ref2.delay,
      createAuthRefreshRequestedAction = _ref2.createAuthRefreshRequestedAction,
      createRequestAttemptsFailedAction = _ref2.createRequestAttemptsFailedAction;
  // The amount of times we try a request before abandoning it.
  var maxAttempts = 3; // The amount of time we wait between retries.

  var waitFor = 3000;

  var handler = /*#__PURE__*/_regenerator["default"].mark(function handler(attemptsLeft) {
    var _len,
        args,
        _key,
        _args = arguments;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            _context.next = 13;
            return put(createAuthRefreshRequestedAction(_context.t0));
          ...
          case 20:
            _context.next = 22;
            return put(createRequestAttemptsFailedAction("Error retrieving data (".concat(maxAttempts, " attempts). This can most likely be resolved by logging in again.")));
