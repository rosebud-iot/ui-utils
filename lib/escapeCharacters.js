 ...
 */
var escChars = exports.escChars = function escChars(str) {
 ...
 * #=> { username: "Laurel O'Sullivan", password: "e3m@PmgA'mLrY9Ds8" }
 */
var escapeCharacters = exports.escapeCharacters = function escapeCharacters(val) {
  var reverse = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var exclude = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  if ((0, _isFunction["default"])(val) || !(0, _isObject["default"])(val) && !(0, _isString["default"])(val)) {
    return undefined;
  }
  var _escAry = function escAry(a) {
    return (0, _map["default"])(a, function (itm) {
      return (0, _isArray["default"])(itm) ? _escAry(itm) : (0, _isObject["default"])(itm) ? _escObj(itm) : (0, _isString["default"])(itm) ? escChars(itm, reverse) : itm;
    });
  };
  var _escObj = function escObj(o) {
    return (0, _isEmpty["default"])(o) ? o : function () {
      var _o = {};
      (0, _forOwn["default"])(o, function (v, k) {
        _o[k] = (0, _some["default"])(exclude, function (field) {
          return field === k;
        }) ? v : (0, _isArray["default"])(v) ? _escAry(v) : v instanceof Date ? new Date(v) : (0, _isObject["default"])(v) ? _escObj(v) : (0, _isString["default"])(v) ? escChars(v, reverse) : v;
      });
      return _o;
    }();
  };
  return (0, _isArray["default"])(val) ? _escAry(val) : (0, _isObject["default"])(val) ? _escObj(val) : (0, _isString["default"])(val) ? escChars(val, reverse) : val;
};
var _default = exports["default"] = escapeCharacters;