...
var escapeCharacters = function escapeCharacters(val) {
  ...
  if (
    (0, _isFunction["default"])(val) ||
    (!(0, _isObject["default"])(val) && !(0, _isString["default"])(val))
  ) {
    return undefined;
  }
  var escAry = function escAry(a) {
    return (0, _map["default"])(a, function (itm) {
      return (0, _isArray["default"])(itm)
        ? escAry(itm)
        : (0, _isObject["default"])(itm)
        ? escObj(itm)
        : (0, _isString["default"])(itm)
      ...
      : (function () {
          ...
          (0, _forOwn["default"])(o, function (v, k) {
            _o[k] = (0, _some["default"])(exclude, function (field) {
              ...
              ? v
              : (0, _isArray["default"])(v)
              ? escAry(v)
              : v instanceof Date
              ? new Date(v)
              : (0, _isObject["default"])(v)
              ? escObj(v)
              : (0, _isString["default"])(v)
              ? escChars(v, reverse)
              : v;
          });
          return _o;
  ...
  return (0, _isArray["default"])(val)
    ? escAry(val)
    : (0, _isObject["default"])(val)
    ? escObj(val)
    : (0, _isString["default"])(val)
