...
import { Validation } from '../src/Form.utils';
  ...
  describe('Method', () => {
    ...
    describe('minChar', () => {
      ...
      it('should throw type error if minCharCount is invalid', () => {
        ...
        expect(() => Validation.minChar(value, minCharCount)).to.throw(TypeError);
      })
    ...
    describe('maxChar', () => {
      ...
      it('should throw type error if maxCharCount is invalid', () => {
        ...
        expect(() => Validation.maxChar(value, maxCharCount)).to.throw(TypeError);
      })
